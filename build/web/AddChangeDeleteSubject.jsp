<%-- 
    Document   : AddChangeDeleteSubject
    Created on : Apr 3, 2017, 11:18:07 PM
    Author     : SMART
--%>
...
<head>
        ...
        <title>เพิ่ม-เปลี่ยน-ถอน วิชาเรียน</title>
    ...
    <body>
        ...
        <form action="ChangeSubjectServlet" method="POST">
            <div class="title">
                <h1>เพิ่ม-เปลี่ยน-ถอน วิชาเรียน</h1>
            </div>
            <div class="container">
            ...
            <table class="table-fill">
                ...
                <tbody class="table-hover">
                    ...
                    <tr>
                        ...
                        <td class="text-left">พฤ.13:00-16:00 น. (ท)</td>
                    ...
                    <tr>
                        ...
                        <td class="text-left">DATABASE SYSTEM CONCEPTS</td>
                        <td class="text-left">3</td>
                        <td class="text-left">
                            <select name="section">
                                <option>1</option>
                        ...
                        <td class="text-left">อ.13:30-15:30 น. (ท)</td>
                        <td class="text-left">55</td>
                    </tr>
                </tbody>
            </table>
            <button  type="button" class="btn btn-success btn-bottomleft">เพิ่ม</button> 
            <button type="button" class="btn btn-danger btn-bottomright">ถอน</button>
        </form>
